...
class SuffixTest(TestCase):
    def test_step(self):
        ...
        state = layer.init_state(None, dtype=jnp.float32)

        state, out0 = layer.step(None, state, input[0], dtype=jnp.float32)
        state, out1 = layer.step(None, state, input[1], dtype=jnp.float32)
        state, out2 = layer.step(None, state, input[2], dtype=jnp.float32)
    ...
    def test_forward(self):
        ...
        out_fw = layer.forward(None, input, dtype=jnp.float32)
        out_fw_fs = layer._forward_from_step(None, input, dtype=jnp.float32)
    ...
    def test_forward_batch(self):
        ...
        out_ff = layer._forward_batch_from_forward(None, input, dtype=jnp.float32)
        out_fs = layer._forward_batch_from_step(None, input, dtype=jnp.float32)

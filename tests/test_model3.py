...
class Model3Test(TestCase):
    ...
    def test_build_model(self):
        ...
        self.assertEqual(
            str(model), "tokens.128.cw.bh-pos.16-emb.64.norm|gru.64-dense.128.relu"
        )
    ...
    def test_neighbors(self):
        ...
        self.assertEqual(
            neighbors,
            {
                ...
                "tokens.128.cw.bh-pos.16-emb.64.norm|gru.64-dense.64.relu-attn.2.2.64",
                "tokens.128.cw.bh-pos.16-emb.64.norm|gru.64-dense.64.relu-attnmq.2.2.64",
                "tokens.128.cw.bh-pos.16-emb.64.norm|gru.64-dense.64.relu-dense.64.gelu",
                "tokens.128.cw.bh-pos.16-emb.64.norm|gru.64-dense.64.relu-dense.64.relu",
                ...
                "tokens.128.cw.bh-pos.16-emb.64.norm|gru.64-dense.64.relu-rec.64.relu",

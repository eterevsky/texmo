...
target/release/texmo -d data/books3_caps_words.txt optimize-tokens -n 256 --fallback-dist --initial-size=108362047381 --processing=caps,words -i tokens/tokens128_capswords_dist.json -o tokens/tokens256_capswords_dist.json
target/release/texmo -d data/books3_caps.txt optimize-tokens -n 256 --fallback-dist --initial-size=108362047381 --processing=caps -i tokens/tokens128_caps_dist.json -o tokens/tokens256_caps_dist.json
